...
const Textarea: FC<UIProps<{ label: string }, "textarea">> = ({
  label,
  ...otherProps
}) => {
  return (
    <div className="relative w-full min-w-[200px]">
      <textarea
        {...otherProps}
        placeholder=" "
        className="peer h-full min-h-[100px] w-full resize-y rounded-[7px] border border-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-gray-200 placeholder-shown:border-t-gray-200 focus:border-2 focus:border-blue-500 focus:border-t-transparent focus:outline-0 disabled:resize-none disabled:border-0 disabled:bg-blue-50"
      />
